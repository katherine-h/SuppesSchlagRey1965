...
prop_switch_positive_reinforcement_trials <- sum(positive_reinforcement_trials$any_reclassifications)
...
binom_result <- binom.test(x = prop_switch_positive_reinforcement_trials, 
